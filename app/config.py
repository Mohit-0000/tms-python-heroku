...
notification_system_url = 'http://localhost:8088/' 

# 'https://excellence_notifyapi.exweb.in/'
accountname = "notify_tms"
weekly_page_link="'http://127.0.0.1:5000/'#/app/week/WeeklyReport?update=true"
...
weekly_notification ={"actions": [
                {
                    ...
                    "url":"http://127.0.0.1:5000/#/app/automateWeekly",
                    "type": "button",
                    "style": "danger",
                    "value": "rating"
                }]

...
def login():
        ...
        print("jhdsagkdahdbkahjdajdabskdbas",response_user_token)
        print("jhdsagkdahdbkahjdajdabskdbas",token)
        if token['data'] == {'message': 'Invalid Login'}:
            ...
            print("hjgsdadasdasdasdasdasdas",payload_user_details)
            response_user_details = requests.post(url=URL+"attendance/sal_info/api.php", json=payload_user_details)
            print("hjdgasdasdasdasdasda",response_user_details.text)
            result = json.loads(response_user_details.text)
            print("sfadasdasdasdasda",result)



            # user_data={"username":"mohitsaini","id":"557","name":"Mohit Saini","user_Id":"576","status":"Enabled","jobtitle":"Python Backend Developer","dob":"1999-07-10","gender":"Male","email":"mohit_saini@excellencetechnologies.info","slack_id":"U025YC7ND8D","profileImage":"https://avatars.slack-edge.com/2021-09-18/2512679017764_d32b7d1337e79201aca9_original.jpg","dateofjoining":"021-11-23T18:14:39.007+00:00","work_email":"mohit_saini@excellencetechnologies.info","last_login":"021-11-23T18:14:39.007+00:00","team":"","role":"Employee","cron_checkin":"false","missed_chechkin_crone":"false"}

...
@jwt_required
def slack():
    print("dygusadsadasdasdasdasd")
    current_user = get_current_user()
    print(current_user)
    # slack = current_user['email']
    # print("dhjsadasd",slack)
    slack='mohit_saini@excellencetechnologies.info'
    ...
    print("asdasdasdasd212sddsdf",slack_channels)
...
def add_weekly_checkin():
    ...
    print("jdhgsadadasdasdasd",users)
    managers_data = []
    for data in users:
